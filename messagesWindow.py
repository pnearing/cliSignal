...
class MessagesWindow(Window):
    ...
    def __init__(self,
        ...
        Window.__init__(self, window, STRINGS['titles']['messages'], top_left, window_attrs, border_attrs,
                        border_focus_attrs, title_attrs, title_focus_attrs, theme, STRINGS['background']['messages'])
        return
